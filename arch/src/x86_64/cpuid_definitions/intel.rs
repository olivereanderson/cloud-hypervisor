    ...
    CpuidDefinitions([
        ...
        (
            ...
            ValueDefinitions::new(&[
                ...
                ValueDefinition {
                    ...
                    bits_range: (2, 2),
                    // The timer is emulated by KVM and thus always always-running :)
                    policy: ProfilePolicy::Static(1),
                },
                ValueDefinition {
                    short: "pln",
        ...
        (
            ...
            ValueDefinitions::new(&[
                ...
                // RAO-INT is deprecated and removed from many compilers as far as we are aware.
                // This policy can be changed if requested in the future.
                ValueDefinition {
                    short: "RAO-INT",
        ...
        (
            ...
            ValueDefinitions::new(&[
                ValueDefinition {
                    short: "asymmetric-rdt-M",
                    description: "At least one logical processor supports Asymmetrical Intel RDT Monitoring Capability",
                    bits_range: (0, 0),
                    policy: ProfilePolicy::Static(0),
                },
                ValueDefinition {
                    short: "asymmetric-rdt-A",
                    description: "At least one logical processor supports Asymmetrical Intel RDT Allocation Capability",
                    bits_range: (0, 0),
                    policy: ProfilePolicy::Static(0),
                },
                ValueDefinition {
                    short: "MSR_IMM",
                    description: "Immediate forms of the RDMSR and WRMSRNS instructions are supported",
                    bits_range: (5, 5),
                    policy: ProfilePolicy::Inherit,
                },
            ]),
        ...
        */
        ...
        (
            ...
            ValueDefinitions::new(&[
                ...
                ValueDefinition {
                    short: "subleaf_5",
                    description: "If 1, subleaf 5 exists. The processor supports Architectural PEBS. The IA32_PEBS_BASE and IA32_PEBS_INDEX MSRs exist",
                    bits_range: (5, 5),
                    policy: ProfilePolicy::Static(0),
                },
            ]),
        ...
        // 0x80000001.EAX and EBX are both Reserved on Intel hence we just zero them out
        (
            Parameters {
                leaf: 0x80000001,
                sub_leaf: RangeInclusive::new(0, 0),
